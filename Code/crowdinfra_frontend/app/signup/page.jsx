        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-gray-800/50 backdrop-blur-lg rounded-3xl shadow-2xl overflow-hidden border border-gray-700/50 p-8">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-blue-400 mt-2">Join our community of real estate enthusiasts</p>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="col-span-2 md:col-span-1">
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-2 bg-gray-700/40 rounded-lg border ${errors.name ? 'border-red-500' : 'border-gray-600'} focus:outline-none focus:ring-2 focus:ring-blue-500`}
                ...
                <div className="col-span-2 md:col-span-1">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-2 bg-gray-700/40 rounded-lg border ${errors.email ? 'border-red-500' : 'border-gray-600'} focus:outline-none focus:ring-2 focus:ring-blue-500`}
                ...
                {/* Gender */}
                <div className="col-span-2 md:col-span-1">
                  <label className="block text-gray-300 mb-1 text-sm" htmlFor="gender">
                    Gender
                  </label>
                  <select
                    id="gender"
                ...
                {/* Age */}
                <div className="col-span-2 md:col-span-1">
                  <label className="block text-gray-300 mb-1 text-sm" htmlFor="age">
                    Age
                  </label>
                  <input
                    type="number"
                ...
                {/* Address */}
                <div className="col-span-2 md:col-span-1">
                  <label className="block text-gray-300 mb-1 text-sm" htmlFor="address">
                    Address
                  </label>
                  <input
                    type="text"
                ...
                <div className="col-span-2 md:col-span-1">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-2 bg-gray-700/40 rounded-lg border ${errors.password ? 'border-red-500' : 'border-gray-600'} focus:outline-none focus:ring-2 focus:ring-blue-500`}
                    placeholder="••••••••"
                  />
                ...
                <div className="col-span-2 md:col-span-1">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-2 bg-gray-700/40 rounded-lg border ${errors.confirmPassword ? 'border-red-500' : 'border-gray-600'} focus:outline-none focus:ring-2 focus:ring-blue-500`}
                    placeholder="••••••••"
                  />
                ...
                <div className="col-span-2">
                  <label className="block text-gray-300 mb-1 text-sm" htmlFor="bio">
                    Bio (Optional)
                  </label>
                  <textarea
                    id="bio"
                ...
                <div className="col-span-2">
                  <div className="flex items-start">
                    ...
                    />
                    <label className="ml-2 block text-sm text-gray-300" htmlFor="agreeTerms">
                      I agree to the <Link href="/terms" className="text-blue-400 hover:underline">Terms and Conditions</Link> and <Link href="/privacy" className="text-blue-400 hover:underline">Privacy Policy</Link>
                    </label>
                  </div>
