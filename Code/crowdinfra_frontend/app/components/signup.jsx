...
// //   return (
// //     <div className='min-h-screen w-full py-5 text-white' style={{backgroundColor: 'transparent'}}>
// //       <div className='container mx-auto px-4 py-8'>
// //         <div className='max-w-full mx-auto'>
// //           <div className=' backdrop-blur-lg rounded-3xl shadow-2xl overflow-hidden p-8' style={{backgroundColor: 'transparent'}}>
...
//         <div
//           className='relative w-24 h-24 rounded-full overflow-hidden bg-gray-700 border-2 border-blue-500 mb-2 cursor-pointer'
...
//           className='hidden'
//         />
//         <p className='text-gray-500 dark:text-gray-400 text-sm'>Upload profile photo</p>
//       </div>
