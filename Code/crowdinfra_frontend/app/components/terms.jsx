...
// // //         <h2 className="text-2xl font-bold mb-4 text-center text-blue-400">Terms and Conditions</h2>
        
// // //         <div className="h-64 overflow-y-auto p-4 bg-gray-700 rounded-md text-gray-300">
// // //           <p className="mb-4">
// // //             Welcome to our platform. By using our services, you agree to comply with the following terms and conditions.
// // //           </p>
          
// // //           <h3 className="text-lg font-semibold text-blue-300">1. User Agreement</h3>
// // //           <p className="mb-4">You must be at least 18 years old to use our services.</p>

// // //           <h3 className="text-lg font-semibold text-blue-300">2. Privacy Policy</h3>
// // //           <p className="mb-4">We respect your privacy and ensure that your data is protected.</p>

// // //           <h3 className="text-lg font-semibold text-blue-300">3. Prohibited Activities</h3>
// // //           <p className="mb-4">
// // //             You agree not to engage in any unlawful or harmful activities while using our services.
// // //           </p>

// // //           <h3 className="text-lg font-semibold text-blue-300">4. Changes to Terms</h3>
// // //           <p className="mb-4">
// // //             We reserve the right to update these terms at any time. Continued use of our platform indicates acceptance of any changes.
// // //           </p>

// // //           <p className="italic text-sm text-gray-400">Last updated: March 2025</p>
// // //         </div>
...
// // //               accepted ? "bg-gray-500 cursor-not-allowed" : "bg-blue-600 hover:bg-blue-500"
// // //             }`}
// // //           >
...
// //           <div className="flex-grow overflow-y-auto bg-gray-800 rounded-xl border border-gray-700 shadow-2xl p-8">
...
// //       <footer className="bg-gray-900 border-t border-gray-700 p-6 shadow-inner">
