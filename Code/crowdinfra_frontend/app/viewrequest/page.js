...
import remarkGfm from 'remark-gfm'
// import { useSearchParams } from 'next/navigation'
>>>>>>> dfd74a9a170335b8a9dcc482ff5702ae7ae28aa9
    ...
    return (
      <div className='min-h-screen flex justify-center items-center bg-black'>
        <div className='bg-gray-900 p-8 rounded-lg shadow-xl border border-gray-700'>
          ...
          <Link
            href='/'
            className='mt-6 inline-block text-blue-400 hover:text-blue-300 hover:underline'
          >
            Return to home
          </Link>
        </div>
    ...
    <div className='min-h-screen bg-black w-full'>
        ...
        <div className='max-w-7xl mx-auto'>
          ...
          <div className='flex flex-wrap gap-3'>
            ...
            <div className='relative group ml-auto'>
              ...
              <div
                id='share-dropdown'
                className='hidden absolute top-full right-0 mt-2 w-56 rounded-md shadow-lg bg-gray-900 border border-gray-700 z-10'
              >
                <div className='py-1'>
                  <button
                    onClick={() => {
                  ...
                  <a
                    href={`mailto:?subject=${encodeURIComponent(
                      ...
                      `I found this interesting demand on CrowdInfra: ${window.location.href}`
                    )}`}
                    className='flex items-center px-4 py-3 text-sm text-gray-200 hover:bg-gray-800 w-full text-left'
                    onClick={() =>
                      document
      ...
      <div className='max-w-7xl mx-auto px-6 sm:px-10 py-8'>
        ...
        <div className='bg-gray-900 rounded-xl shadow-2xl overflow-hidden mb-10 transform transition-all hover:scale-[1.01]'>
          <div className='p-6 sm:p-8'>
            ...
            <div className='bg-gray-800 rounded-lg p-6 border border-gray-700'>
              <p className='text-gray-100 whitespace-pre-wrap text-lg'>
                {request.description}
              </p>
            </div>
          </div>
              ...
              <div className='bg-gray-800 rounded-lg p-1 border border-gray-700'>
                ...
                <div className='p-4 bg-gray-800 border-t border-gray-700'>
                  <p className='text-gray-300 flex items-center'>
                    ...
                    Coordinates: {request.location.coordinates[1]},{' '}
        ...
        <div className='flex justify-between items-center mt-12'>
          <Link
            href='/'
            className='inline-flex items-center px-6 py-3 bg-blue-600 border border-transparent rounded-lg font-medium text-white hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors shadow-lg hover:shadow-xl'
          >
            <svg
              xmlns='http://www.w3.org/2000/svg'
              className='h-5 w-5 mr-2'
