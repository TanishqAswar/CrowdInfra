        ...
        <div className='container mx-auto px-4 py-8 mt-8'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
            ...
            <div className='md:col-span-2 rounded-xl overflow-hidden shadow-2xl relative'>
              ...
              >
                {/* Rest of the map markers and InfoWindows remain the same as in the previous implementation */}
                ...
                {/* Previous marker rendering code remains the same */}
              </GoogleMap>
            </div>
          </div>

          {/* Form Overlay remains the same as in the previous implementation */}
          {showForm && (
