...
const RaiseRequestPage = () => {
  ...
  return (
    ...
    transition-all duration-500 perspective-1000">
      ...
      <div className="container mx-auto px-4 py-6 transform transition-all duration-700 hover:scale-[1.01]">
        <h1 className="text-4xl font-bold mt-8 mb-12 text-center text-transparent bg-clip-text bg-gray-200 transition-all duration-300 hover:scale-105
          hover:brightness-125">
          Raise Facility Request
        </h1>

        <div className="mb-6 flex items-center justify-center">
          <div className="w-1/2 transform transition-all duration-500 hover:scale-105 hover:shadow-2xl">
            <PlaceAutocomplete />
          </div>
        </div>

        <div className="rounded-xl overflow-hidden shadow-2xl transition-all duration-500 
        ...
        {showForm && (
          <form
            onSubmit={handleSubmit}
            className="max-w-3xl mx-auto mt-8 bg-white/10 backdrop-blur-lg p-8 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <input
                  ...
                  text-white focus:border-blue-500 focus:ring-2 focus:ring-blue-500 
              ...
              {/* Remaining form fields with similar hover effects */}
            </div>
        ...
        <div className="mt-12">
          <h2 className="text-3xl font-bold mb-6 text-center text-gray-200 
          hover:tracking-wider transition-all duration-500">
            Community Requests
          </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {requests.map((request) => (
                <div
                  ...
                  hover:rotate-1"
                >
                  {/* Existing request card content with additional hover effects */}
                  <h3 className="text-xl font-bold text-blue-400 mb-2 
